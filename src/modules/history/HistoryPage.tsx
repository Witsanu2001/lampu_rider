  ...
  return (
    <div className="h-full w-full flex flex-col bg-gray-50 text-gray-800 overflow-hidden animate-fade-in">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-4 py-4 space-y-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none bg-gray-50/50 pb-24"
      >
        {loading && page === 1 ? (
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <span className="bg-emerald-50 text-emerald-600 text-[11px] font-bold px-2.5 py-1 rounded-md flex items-center gap-1 w-fit mb-2">
                      ✅ จัดส่งสำเร็จ
                    </span>
