...
export default function JobsPage() {
  ...
  return (
    <div className="p-4 flex flex-col gap-4 animate-fade-in relative transition-colors duration-300">
      ...
      <div className="font-bold text-gray-800 dark:text-gray-100 text-lg flex items-center gap-2">
        ...
        <span className="bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 px-2 py-0.5 rounded-full text-xs">
          {jobs.length}
        </span>
      </div>
          ...
          return (
            <div
              ...
              className={`rounded-2xl p-5 text-white shadow-lg relative overflow-hidden transition-all duration-300 ${
                isShipping
                  ? "bg-linear-to-br from-emerald-500 to-green-600 dark:from-emerald-600 dark:to-green-800"
                  : "bg-linear-to-br from-orange-500 to-red-600 dark:from-orange-600 dark:to-red-800"
              }`}
            >
      ...
      {/* 🌟 Modal ยืนยัน (รวมอันเดียวแล้ว) */}
      {confirmModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 w-full max-w-sm shadow-2xl animate-slide-up border border-gray-100 dark:border-gray-700">
            {/* ไอคอนด้านบน */}
            <div
            ...
            {confirmModal.nextStatus === "cancel" ? (
              <div className="mb-6 text-left">
                ...
                {refuseReason === "อื่นๆ" && (
                  <textarea
                    className="w-full border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-white rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 resize-none animate-fade-in"
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm text-center mb-6 leading-relaxed px-2">
                {confirmModal.nextStatus === "shipping"
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3.5 font-bold text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              >
                ยกเลิก
              </button>
              <button
